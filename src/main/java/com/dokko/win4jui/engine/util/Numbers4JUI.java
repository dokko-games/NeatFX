package com.dokko.win4jui.engine.util;
...
public class Numbers4JUI {
    /**
     * {@link Numbers4JUI#nearestPerfectSquare(int, int)} mode that returns the nearest number: equal, above or below
     */
    public static final int NPS_MODE_NEAREST = 0;
    /**
     * {@link Numbers4JUI#nearestPerfectSquare(int, int)} mode that returns the nearest number: equal or below
     */
    public static final int NPS_MODE_BELOW = 1;
    /**
     * {@link Numbers4JUI#nearestPerfectSquare(int, int)} mode that returns the nearest number: equal or above
     */
     ...
     * @see Numbers4JUI#NPS_MODE_NEAREST
     * @see Numbers4JUI#NPS_MODE_BELOW
     * @see Numbers4JUI#NPS_MODE_ABOVE
     */
